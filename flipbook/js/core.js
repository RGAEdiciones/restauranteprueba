...
document.addEventListener('DOMContentLoaded', function() {
    var music = document.getElementById('musicbg');
    music.volume = 0.5; // Establecer volumen al 50%
...
function loadPage(page, pageElement) {
    ...
    // Si la imagen en formato .jpg no se carga correctamente, intenta cargarla en formato .gif
    img.error(function() {
        img.attr('src', flipbookcfg.url + (page - flipbookcfg.cover) + '.gif');
    });
...
$(".controlzoom").hide();
    ...
    $("#slider").slider({
        ...
        start: function (event, ui) {
            ...
            var currentPage = ui.value;
            var firstThumbnail = (currentPage - 1) * 2;
            var lastThumbnail = Math.min(firstThumbnail + 1, totalPages - 1);
    
            if (currentPage == 1) {
                $(ui.handle).find('.thumbnail div').html('<img src="' + flipbookcfg.url + currentPage + '-thumb.jpg, ' + flipbookcfg.url + currentPage + '-thumb.gif" style="width: 100%; height: 100%;" />');
            } else if (currentPage == totalPages) {
                $(ui.handle).find('.thumbnail div').html('<img src="' + flipbookcfg.url + (totalPages - 1) + '-thumb.jpg, ' + flipbookcfg.url + (totalPages - 1) + '-thumb.gif" style="width: 100%; height: 100%;" /><img src="' + flipbookcfg.url + totalPages + '-thumb.jpg, ' + flipbookcfg.url + totalPages + '-thumb.gif" style="width: 100%; height: 100%;" />');
            } else {
                $(ui.handle).find('.thumbnail div').html('<img src="' + flipbookcfg.url + firstThumbnail + '-thumb.jpg, ' + flipbookcfg.url + firstThumbnail + '-thumb.gif" style="width: 49%; height: 100%;" /><img src="' + flipbookcfg.url + lastThumbnail + '-thumb.jpg, ' + flipbookcfg.url + lastThumbnail + '-thumb.gif" style="width: 49%; height: 100%;" />');
            }
        },
