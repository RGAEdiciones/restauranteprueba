...
$(".controlzoom").hide();		
    ...
    $("#slider").slider({
        ...
        start: function (event, ui) {
            ...
            if (ui.value == 1) {
                $(ui.handle).find('.thumbnail div').html('<img src="' + flipbookcfg.url + ui.value + '-thumb.jpg, -thumb.gif" style="width: 100%; height: 100%;" />');
            } else if (ui.value == lst) {
                $(ui.handle).find('.thumbnail div').html('');
                if (nps % 2 != 0) {
                    $(ui.handle).find('.thumbnail div').html('<img src="' + flipbookcfg.url + ((ui.value - 1) * 2) + '-thumb.jpg, -thumb.gif" style="width: 49%; height: 100%;" /><img src="' + flipbookcfg.url + ((ui.value - 1) * 2 + 1) + '-thumb.jpg" style="width: 49%; height: 100%;" />');
                } else {
                    $(ui.handle).find('.thumbnail div').html('<img src="' + flipbookcfg.url + ((ui.value - 1) * 2) + '-thumb.jpg, -thumb.gif" style="width: 100%; height: 100%;" />');
                }
            } else {
                $(ui.handle).find('.thumbnail div').html('');
                $(ui.handle).find('.thumbnail div').html('<img src="' + flipbookcfg.url + ((ui.value - 1) * 2) + '-thumb.jpg, -thumb.gif" style="width: 49%; height: 100%;" /><img src="' + flipbookcfg.url + ((ui.value - 1) * 2 + 1) + '-thumb.jpg" style="width: 49%; height: 100%;" />');
        ...
        slide: function (event, ui) {
            ...
            if (ui.value == 1) {
                ...
                $(ui.handle).find('.thumbnail div').html('');
                if (nps % 2 != 0) {
                    $(ui.handle).find('.thumbnail div').html('<img src="' + flipbookcfg.url + ((ui.value - 1) * 2) + '-thumb.jpg, -thumb.gif" style="width: 49%; height: 100%;" /><img src="' + flipbookcfg.url + ((ui.value - 1) * 2 + 1) + '-thumb.jpg, -thumb.gif" style="width: 49%; height: 100%;" />');
                } else {
                    $(ui.handle).find('.thumbnail div').html('<img src="' + flipbookcfg.url + ((ui.value - 1) * 2) + '-thumb.jpg, -thumb.gif" style="width: 100%; height: 100%;" />');
                }
            } else {
